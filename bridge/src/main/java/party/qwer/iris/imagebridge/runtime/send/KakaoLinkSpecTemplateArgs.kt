...
internal fun hasExplicitKakaoLinkTemplateArgs(rawAttachment: String): Boolean = BridgeCore.coreHasKakaoLinkExplicitTemplateArgs(rawAttachment)

internal fun hasResolvedIrisKakaoLinkTemplate(rawAttachment: String): Boolean = BridgeCore.coreHasResolvedIrisKakaoLinkTemplate(rawAttachment)
