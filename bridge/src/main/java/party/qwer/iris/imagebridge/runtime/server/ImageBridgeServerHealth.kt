    ...
    ImageBridgeHealthSnapshot(
        ...
        capabilities =
            currentBridgeCapabilities(
                ...
                registryError = lastRegistryError,
                specReady = specStatus?.ready == true,
                notificationActionSupported = notificationActionSupported,
                textSendCapability = textSendCapability,
                sendTextEnabled = textBridgeSendTextEnabled,
                sendMarkdownEnabled = textBridgeSendMarkdownEnabled,
            ),
        metrics = metrics,
...
internal fun ImageBridgeServer.healthSnapshot(): ImageBridgeHealthSnapshot =
    buildImageBridgeHealthSnapshot(
        ...
        notificationActionSupported = notificationActionSupported.get(),
